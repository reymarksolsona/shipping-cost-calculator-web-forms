<%@ Page Title="Edit" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Exercise2WebForms.Pages.Customer.Edit" %> <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ul class="breadcrumb">
        <li>
                ...
                <asp:Panel ID="pnlCustomer" runat="server" CssClass="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="form-group text-left">
                            ...
                            <asp:TextBox ID="txtPhoneNumber" runat="server" CssClass="form-control" Text='<%# Bind("PhoneNumber") %>'>
                            </asp:TextBox>
                    ...
                    <div class="modal-footer">
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button ID="btnUpdate" runat="server" Text='Save' CssClass="btn btn-default" OnClick="btnUpdate_Click" ValidationGroup="CreateCustomerValidation" />
                                <asp:Button ID="Button1" runat="server" Text="Cancel" CssClass="btn btn-default" CausesValidation="false" />
                            </div>
                        </div>
                    </div>
                </asp:Panel>
