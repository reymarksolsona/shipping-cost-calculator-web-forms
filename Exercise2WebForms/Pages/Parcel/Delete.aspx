<%@ Page Title="Delete" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Exercise2WebForms.Pages.Parcel.Delete" %>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <dl class="dl-horizontal">
                            <dt>Title :</dt>
                            <dd><asp:Label ID="lblTitle" runat="server" /></dd>
                        </dl>
                    </div>
